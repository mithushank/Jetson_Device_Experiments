...
tegrastats_process = start_tegrastats(interval=interval,output_file='tegrastats_output_agem_cifar10.txt')
...
total_gpu_soc_power, total_cpu_cv_power, total_power = parse_tegrastats_output('tegrastats_output_agem_cifar10.txt', interval)
...
csv_file_name = 'results_agem_cifar10.csv'
